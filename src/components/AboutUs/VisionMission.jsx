...
function VisionMission() {
  return (
    <div className='flex flex-col lg:flex-row  gap-3 lg:gap-12'>
        ...
        <div className='bg-[#0C8CE90F] p-6'>
            <h1 className='text-2xl font-bold text-start mb-6 uppercase'>MISSION</h1>
            <p className='mb-6 text-base'>Our mission is to provide accurate, timely, and unbiased news that informs, educates, and engages our readers. We are committed to upholding the highest standards of journalism, ensuring that every story we publish is credible, well-researched, and relevant. By leveraging cutting-edge technology and innovative storytelling, we strive to create a seamless and interactive news experience. we aim to foster a well-informed society by covering a diverse range of topics, from global affairs to local news, politics, business, technology, entertainment, and more.</p>
        </div>
    </div>
  )
}
